...
function activ_deactiv_radius = ImgAI3_User_Interface(X,XX,Xroi,ROI,subject,option)
% X = '/Volumes/cerebro/Studies/KLU_APC2/Public/Analysis/data/';
% XX = '/step03_FaceNames/FirstLevel/con_0003.nii';
...
%appending 900 and 800 ID to the FWHM radius matrix
    activ_deactiv_radius(:,1) = subject(:,1);
    activ_deactiv_radius(:,2) = subject(:,2);
